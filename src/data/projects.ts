...
export const projects: Project[] = [
  {
    ...
    descriptions: [
      ...
      "H3::Weekly design QA during build",
      "Two flows changed mid-build from edge cases engineers surfaced. The failed payment retry state revealed that users expected to know why a payment failed (insufficient funds vs network error vs card issue) , not just that it did. I designed three distinct error states with clear next actions instead of a generic retry button. The empty rewards state (“no rewards earned yet”) needed to feel like an invitation, not a dead end , I replaced a blank screen with a progress prompt showing the user exactly what action would earn their first reward.",
